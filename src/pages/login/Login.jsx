...
const Login = () => {
    ...
    return (<div>
    <div className="head flex justify-center mt-10 text-4xl font-bold text-blue-800">
        LOGIN TO YOUR ACCOUNT   
        </div>
        
    <div className="login flex flex-col items-center justify-center ">
        <div className="lContainer mt-40"></div>
            ...
            <button disabled={loading} onClick={handleClick} className="lButton bg-sky-600 text-white w-28 h-9 text-center mt-4 mr-2 rounded-md border-2 text-sm font-semibold cursor-pointer">Login</button>
...
//             <input type="text" placeholder="username" id="username" onChange={handleChange} className="lInput text-sm text-gray-base mr-3 py-7 px-4 h-2 border border-gray-600 rounded mb-2" />
//             <input type="password" placeholder="password" id="password" onChange={handleChange} className="lInput text-sm text-gray-base mr-3 py-7 px-4 h-2 border border-gray-600 rounded mb-2" />
