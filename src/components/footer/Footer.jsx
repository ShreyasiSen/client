...
const Footer = () => {
  return (
    <div className="Footer">
        <div className="fLists flex justify-between gap-2 ml-52 mr-52 mt-8 text-blue-900 mb-28">
            <ul className="fList">
        ...
        <div className="fText mb-10 text-center">Copyright © 2023 Shreybooking.</div>
    </div>
  )
}
